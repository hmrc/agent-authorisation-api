...
import uk.gov.hmrc.agentauthorisation.stubs.{ ACAStubs, ACRStubs, AuthStubs, DataStreamStubs }
import uk.gov.hmrc.play.test.UnitSpec

abstract class BaseISpec
  extends UnitSpec with OneAppPerSuite with WireMockSupport with AuthStubs with ACAStubs with DataStreamStubs with ACRStubs {
